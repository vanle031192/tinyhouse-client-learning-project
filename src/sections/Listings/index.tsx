...
export const Listings = ({ match }: RouteComponentProps<MatchParams>) => {
  ...
  const notiTextWithNotBillGoogleApi = match.params.location ? (
    <div>
      <h2>Results for "${match.params.location}"</h2>
      <h4>
        Can't get the results because this search with googlecodingApi is not
        billed
      </h4>
    </div>
  ) : null;
  ...
  return (
    <Content className="listings">
      <h1>List of listings for you</h1>
      {notiTextWithNotBillGoogleApi}
